        ...
        o.prototype.bind = function() {
            ...
            var $ = function(t, n, r) {
                ...
                var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : ""
                  ...
                  , u = l ? '<a class="vnick" rel="nofollow" href="' + S.default.escape(l) + '" target="_self" >' + c + "</a>" : '<span class="vnick">' + c + "</span>"
